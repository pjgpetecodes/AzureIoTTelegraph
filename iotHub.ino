...
//
// You need to copy the platform.local.txt file from this directory to (change the version depending on which is the latest);
//
...
void readMessage(String message, char *payload)
{
...
void sendMessage(String message) 
{
    ...
    readMessage(message, messagePayload);    
    ...
    (void)IoTHubMessage_SetProperty(message_handle, "telegraphmessage", "true");
